...
(defmethod mouse-get-x ((f frame))
  (frame-x f))
(defmethod mouse-get-y ((f frame))
  (frame-y f))
(defmethod mouse-get-width ((f frame))
  (frame-width f))
(defmethod mouse-get-height ((f frame))
  (frame-height f))

(defmethod mouse-get-x ((w window))
  (mouse-get-x (window-parent w)))
(defmethod mouse-get-y ((w window))
  (mouse-get-y (window-parent w)))
(defmethod mouse-get-width ((w window))
  (mouse-get-width (window-parent w)))
(defmethod mouse-get-height ((w window))
  (mouse-get-height (window-parent w)))

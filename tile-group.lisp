...
"Split current frame in n rows of equal size. This is analogous to `vsplit', not `hsplit'."
  (split-frame-eql-parts (current-group) :row amt))

(defcommand (vsplit-equally tile-group) (amt)
    ((:number "Enter the number of frames: "))
"Split current frame in n columns of equal size. This is analogous to `hsplit', not `vsplit'."
